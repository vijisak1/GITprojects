...
public interface WdMethods
{
	...
	/**
	 * This method will launch the any browser and maximise the browser and set the
	 ...
	 * 
	 * @param locator
	 *            - The locator by which the element to be found
	 * @param locValue
	 *            - The locator value by which the element to be found
	 * @author Babu - TestLeaf
	 ...
	 * 
	 * @param ele
	 *            - The Webelement (text field) in which the data to be entered
	 * @param data
	 ...
	 * 
	 * @param ele
	 *            - The Webelement (button/link/element) to be clicked
	 * @author Babu - TestLeaf
	 */
	 ...
	 * 
	 * @param ele
	 *            - The Webelement (button/link/element) in which text to be
	 *            retrieved
	 * @author Babu - TestLeaf
	 */
	 ...
	 * 
	 * @param ele
	 *            - The Webelement (dropdown) to be selected
	 * @param value
	 ...
	 *            - The Webelement (dropdown) to be selected
	 * @param index
	 *            The index to be selected from the dropdown
	 * @author Babu - TestLeaf
	 */
	 ...
	 * 
	 * @param ele
	 *            - The Webelement in which the text to be need to be verified
	 * @param expectedText
	 *            - The expected text to be verified
	 * @author Babu - TestLeaf
	 */
	 ...
	 * 
	 * @param ele
	 *            - The Webelement in which the attribute value to be need to be
	 *            verified
	 * @param attribute
	 *            - The attribute to be checked (like value, href etc)
	 * @param value
	 ...
	 * 
	 * @param ele
	 *            - The Webelement (Radio button, Checkbox) to be verified
	 * @author Babu - TestLeaf
	 */
	 ...
	 * 
	 * @param index
	 *            The window index to be switched to. 0 -> first window
	 * @author Babu - TestLeaf
	 */
	 ...
	 * 
	 * @param ele
	 *            - The Webelement (frame) to be switched
	 * @author Babu - TestLeaf
	 */
